...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
    ...
    (
        ...
        KC_CAPS,     KC_LDCQ,    KC_RDCQ,    KC_LSCQ,    KC_RSCQ,    KC_PLMI,    KC_MDSH,    KC_UNDS,    KC_EQL,     KC_LCBR,    KC_RCBR,    KC_TILD,
        _______,     CK_M1,      CK_M2,   LCAG(KC_F10),  KC_BTN3,    KC_NOEQ,    KC_NDSH,    KC_MUTE,    KC_VOLD,    KC_VOLU,    KC_PGUP,    KC_PIPE,
