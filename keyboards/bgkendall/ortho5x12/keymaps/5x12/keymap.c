...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
    ...
    (
        ...
        KC_CAPS,     KC_LDCQ,    KC_RDCQ,    KC_LSCQ,    KC_RSCQ,    SCMD(KC_4), KC_MPLY,    KC_MUTE,    KC_VOLD,    KC_VOLU,    KC_EQL,     KC_GRV,
        _______,     CK_M1,      CK_M2,   LCAG(KC_F10),  KC_BTN3,    KC_UNDS,    KC_NDSH,    KC_MDSH,    KC_BRID,    KC_BRIU,    KC_PGUP,    KC_BSLS,
